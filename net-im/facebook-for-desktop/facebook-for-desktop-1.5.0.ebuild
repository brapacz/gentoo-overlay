...
SRC_URI="
	x86? ( https://github.com/Aluxian/Facebook-Messenger-Desktop/releases/download/v${PV}-beta.0/Messenger_linux32.deb )
	amd64? ( https://github.com/Aluxian/Facebook-Messenger-Desktop/releases/download/v${PV}-beta.0/Messenger_linux64.deb  )
"
